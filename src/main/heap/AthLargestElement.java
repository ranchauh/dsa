...
public class AthLargestElement {
    public static List<Integer> solve(int k, List<Integer> arr) {
    ...
    public static void main(String[] args) {
        System.out.println(solve(4, Arrays.asList(1, 2 ,3, 4, 5, 6))); // [-1, -1, -1, 1, 2, 3]
        System.out.println(solve(2, Arrays.asList(15, 20, 99, 1))); // [-1, 15, 20, 20]
    }
}
