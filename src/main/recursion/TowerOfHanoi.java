...
public class TowerOfHanoi {
    public ArrayList<ArrayList<Integer>> towerOfHanoi(int A) {
        ...
        return towerOfHanoi(A, 1, 3, 2, output);
    }

    ArrayList<ArrayList<Integer>> towerOfHanoi(int curDisk, int src, int dest, int aux, ArrayList<ArrayList<Integer>> output) {
        if(curDisk == 0) {
            return output;
        }

        towerOfHanoi(curDisk-1, src, aux, dest, output);
        ...
        towerOfHanoi(curDisk-1, aux, dest, src, output);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ob.towerOfHanoi(3)); // [1 1 3 ] [2 1 2 ] [1 3 2 ] [3 1 3 ] [1 2 1 ] [2 2 3 ] [1 1 3 ]
    }
}
